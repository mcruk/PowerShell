...
foreach ($row in $data) {
    if (ContainsSENData $row) {
		...
		$tableRows += "<tr><td>Child's preferred surname</td><td>$($row."[Child's Basic Details] Child's preferred surname")</td><td align='center' rowspan='10' style='vertical-align: middle;width: 360px;padding: 0px'><img src='$([String]$SudentImage)' width='300' height='300'></td></tr>"	
